...
AnalyzeAppModule = __decorate([
    core_1.NgModule({
        imports: [material.MdCheckboxModule, platform_browser_1.BrowserModule, forms_1.FormsModule, http_1.HttpModule, forms_1.ReactiveFormsModule, ng2_signalr_1.SignalRModule.forRoot(createConfig)],
